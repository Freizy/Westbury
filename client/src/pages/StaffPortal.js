  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Refresh staff data after successful login
        fetchStaffMembers();
      } else {
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => setMessage(''), 3000);
        // Refresh staff data after successful logout
        fetchStaffMembers();
      } else {
    ...
    <div className="min-h-screen bg-[#F2F1ED] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          />
          <p className="text-[#838FBF] font-sans text-lg">Staff Attendance Portal</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6 text-center">
          <div className="flex items-center justify-center space-x-2 mb-2">
            ...
            <span className="text-sm font-sans text-[#838FBF]">Current Time</span>
          </div>
        ...
        {currentLog && (
          ...
          >
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-sans font-medium text-blue-800">Current Session</span>
            </div>
            <div className="text-sm font-sans text-blue-700">
              <p><strong>Staff:</strong> {currentLog.staffName}</p>
              <p><strong>Date:</strong> {currentLog.date}</p>
              <p><strong>Time In:</strong> {currentLog.timeIn}</p>
            </div>
          </motion.div>
        )}
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-sm font-sans font-medium text-[#161616] mb-2">Instructions:</h3>
