...
import { ArrowRight, Star, MapPin, Users, Wifi, Car, Coffee } from 'lucide-react';
...
const Home = () => {
  ...
  const suiteImageMap = {
    'KARR - 1 Bedroom Penthouse': 'https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=800&q=80',
    'RONY - 1 Bedroom Penthouse': 'https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=800&q=80',
    'ALLY - 2 Bedroom Plus Ensuite': 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=800&q=80',
    'EBB - 2 Bedroom Standard Ensuite': 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&w=800&q=80',
    'KIKI - 2 Bedroom Penthouse': 'https://images.unsplash.com/photo-1519974719765-e6559eac2575?auto=format&fit=crop&w=800&q=80',
    'LIZ - 2 Bedroom Standard Ensuite': 'https://images.unsplash.com/photo-1465101178521-c1a9136a3b41?auto=format&fit=crop&w=800&q=80',
    'MIMI - 2 Bedroom Plus Ensuite': 'https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=800&q=80',
    'Studio Suite': 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&w=800&q=80',
    'One Bedroom Suite': 'https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=800&q=80',
    'Two Bedroom Suite': 'https://images.unsplash.com/photo-1519974719765-e6559eac2575?auto=format&fit=crop&w=800&q=80',
    'Penthouse Suite': 'https://images.unsplash.com/photo-1465101178521-c1a9136a3b41?auto=format&fit=crop&w=800&q=80',
  };
    ...
    <div className="min-h-screen bg-[#F2F1ED]">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src={require('../Images/IMAGES/EXTERIOR DAY.JPG')}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              Experience the pinnacle of luxury living with WESTBURY HOMES—a fusion of elegance and modern design. Our meticulously crafted apartments, strategically located for convenience and tranquility, offer a perfect blend of style and functionality.
              </p>
              <p className="text-lg text-body mb-8 font-sans">
              Discover a range of residences tailored to diverse preferences—whether you desire a serene retreat, a dynamic urban dwelling, or a vibrant community. Join us in redefining the art of living and embrace the prestige of Westbury Homes. Your dream apartment awaits—where luxury meets lifestyle!
            ...
            >
              <img
                src={require('../Images/IMAGES/EXTERIOR NIGHT.JPG')}
              ...
              {featuredSuites.slice(0, 3).map((suite, index) => (
                ...
                >
                  <div className="relative h-64 overflow-hidden">
                    {(() => {
                      let imageUrl = Array.isArray(suite.images) && suite.images.length > 0 ? suite.images[0] : null;
                      // Use the new labeled images from IMAGES folder
                      if (imageUrl && imageUrl.startsWith('client/src/Images/IMAGES/')) {
                        ...
                        imageUrl = suiteImageMap[suite.title] || 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=2070&q=80';
                      }
                      return (
                        <img
                          src={imageUrl}
