    ...
    <div className="min-h-screen bg-[#F2F1ED] flex items-center justify-center p-4">
      ...
      >
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleInputChange}
                required
                className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#710014] font-sans"
                placeholder="Enter your password"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#838FBF] hover:text-[#161616]"
              >
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          <h3 className="text-sm font-sans font-medium text-[#161616] mb-2">Default Admin Credentials:</h3>
          <div className="text-xs font-sans text-[#838FBF] space-y-1">
            <p><strong>Email:</strong> admin@westburyhomes.com</p>
