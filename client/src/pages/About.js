            ...
            {[
              {
                ...
                description: 'Situated in the prestigious East Legon neighborhood, offering easy access to business districts, shopping centers, and cultural attractions.',
                icon: '📍'
              },
              {
                title: 'Luxury Design',
                description: 'Each suite features contemporary design with premium finishes, creating an atmosphere of sophisticated elegance.',
                icon: '✨'
              },
              {
                title: 'World-Class Amenities',
                description: 'From high-speed WiFi to secure parking, every amenity is designed to enhance your stay and provide ultimate comfort.',
                icon: '🏆'
              },
              {
                title: 'Exceptional Service',
                description: 'Our dedicated team is committed to providing personalized service that exceeds your expectations.',
                icon: '👥'
              },
              {
                title: 'Safety & Security',
                description: '24/7 security with CCTV surveillance ensures your peace of mind throughout your stay.',
                icon: '🔒'
              },
              {
                title: 'Flexible Accommodation',
                description: 'Choose from studio suites to premium penthouses, each designed to meet different needs and preferences.',
                icon: '🏠'
              }
            ].map((feature, index) => (
              <motion.div
                ...
                transition={{ duration: 0.8, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="p-6 bg-[#F2F1ED] rounded-2xl hover:bg-[#710014] hover:text-white transition-all duration-300 group"
              >
      ...
      <section className="py-20 bg-[#F2F1ED]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                src={require('../Images/IMAGES/about.JPG')}
