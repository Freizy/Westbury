    ...
    <footer className="bg-[#161616] text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-garamond font-semibold mb-6">Quick Links</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-white/80 hover:text-white transition-colors font-sans">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/suites" className="text-white/80 hover:text-white transition-colors font-sans">
                  Our Suites
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-white/80 hover:text-white transition-colors font-sans">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-white/80 hover:text-white transition-colors font-sans">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          {/* Our Suites */}
          <div>
            <h4 className="text-lg font-garamond font-semibold mb-6">Our Suites</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/suites" className="text-white/80 hover:text-white transition-colors font-sans">
                  Studio Suite
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-garamond font-semibold mb-6">Contact Info</h4>
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white/80 font-sans">enquiries@westburyhomesgh.com</span>
              </div>
            </div>
          </div>
        </div>
